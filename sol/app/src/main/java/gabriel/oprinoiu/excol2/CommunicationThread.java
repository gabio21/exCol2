    ...
    public void run() {
        ...
        try {
            ...
            if (city == null || city.isEmpty() || informationType == null || informationType.isEmpty()) {
                Log.e(Constants.COMMUNICATION_THREAD_TAG, "[COMMUNICATION THREAD] Error receiving parameters from client (city / information type!");
                return;
            }
            HashMap<String, WeatherForecastInformation> data = serverThread.getData();
            WeatherForecastInformation weatherForecastInformation = null;
            if (data.containsKey(city)) {
                Log.i(Constants.COMMUNICATION_THREAD_TAG, "[COMMUNICATION THREAD] Getting the information from the cache...");
            ...
            if (weatherForecastInformation == null) {
                Log.e(Constants.COMMUNICATION_THREAD_TAG, "[COMMUNICATION THREAD] Weather Forecast Information is null!");
                return;
            }
            String result = null;
            switch (informationType) {
                ...
                case Constants.CONDITION:
                    result = weatherForecastInformation.getGeneral_state();
                    break;
            ...
            Log.e(Constants.COMMUNICATION_THREAD_TAG, "[COMMUNICATION THREAD] An exception has occurred: " + jsonException.getMessage());
            if (Constants.DEBUG) {
